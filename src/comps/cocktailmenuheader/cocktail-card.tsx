...
export const CocktailMenuHeader = () => {
    ...
    return (
        ...
        <h3>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quae expedita enim odio eaque.</h3>
        <h3>repellat blanditiis facilis doloribus accusantium amet saepe!</h3>
        </CocktailHeaderContainer>
    )
}
